    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            try {
                ...
                Swal.fire({
                    title: 'Thông báo',
                    text: 'Bạn có chắc chắn muốn cập nhật địa chỉ này không?',
                    icon: 'warning',
                    showCancelButton: true,
                }).then((result) => {
                    if (result.isConfirmed) {
                        onEditAddress(updatedAddressData)
                        handleClose()
                    }
                })
            } catch (error) {
                ...
                <div className="overflow-y-auto" style={{ maxHeight: '400px' }}>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3 fs-4">
                            ...
                            <div className="my-3">
                                <TomTomMap initialLocation={mapLocation} onLocationChange={setMapLocation} height="200px" setLocation={setLocation} />
                            </div>
                        </Form.Group>
