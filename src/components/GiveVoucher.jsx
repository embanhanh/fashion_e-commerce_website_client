...
function GiveVoucher({ isOpen, onClose, userId }) {
        ...
        <Modal show={isOpen} onHide={onClose} centered>
            ...
            <Modal.Body>
                ...
                <div className="d-flex align-items-center">
                    <p className={`fs-4 py-2 px-4 flex-grow-1 order-tab-item text-center ${filter.status === 'ongoing' ? 'active' : ''}`} onClick={() => setFilter({ ...filter, status: 'ongoing' })}>
                        Đang diễn ra
                    </p>
                    <p className={`fs-4 py-2 px-4 flex-grow-1 order-tab-item text-center ${filter.status === 'upcoming' ? 'active' : ''}`} onClick={() => setFilter({ ...filter, status: 'upcoming' })}>
                        Sắp diễn ra
                    </p>
                </div>
            ...
            <Modal.Footer>
                <button className="primary-btn shadow-none rounded-0 px-3 py-2">
                    <p>Tặng</p>
                </button>
