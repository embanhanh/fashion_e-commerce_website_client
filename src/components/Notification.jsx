...
// function Notification({ title, description, isClosed, type, children }) {
//     return (
//         <>
//             <div className="notification-card">
//                 <div className="d-flex align-items-center justify-content-around w-100" style={{ minHeight: '80px' }}>
//                     <svg className={`wave ${type}`} viewBox="0 0 2000 200" xmlns="http://www.w3.org/2000/svg">
//                         <path
...
//                         <p className={`message-text ${type}`}>{title}</p>
