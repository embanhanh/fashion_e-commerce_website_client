...
function Payment() {
    return <div className="policy-container lh-lg" >
        ...
        <div className="policy-section">
            ...
            <p className="fs-3">Khi nhận hàng và kiểm tra xong bao bì đóng gói sản phẩm, Quý khách hàng thanh toán bằng tiền mặt cho nhân viên giao hàng (shipper).</p>
            <p className="fs-3 fw-bold">2. Chuyển khoản ngân hàng</p>
            <p className="fs-3">Quý khách hàng có thể chọn hình thức thanh toán bằng chuyển khoản ngân hàng.</p>
        </div>
    </div>
}
