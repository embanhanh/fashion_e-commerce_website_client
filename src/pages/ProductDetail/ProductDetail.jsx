    ...
    return (
        <>
                    ...
                    <div style={{ width: '60%' }} className="px-5 py-1 ms-5">
                        ...
                        <div className="d-flex py-3">
                            <p className="fs-3 lh-1 fw-medium d-flex align-items-center">
                                <span className="me-2 fs-3 fw-medium">{currentProduct.rating} </span> <Rating initialValue={currentProduct.rating} readonly={true} size={25} className="mx-3" /> (100
                                đánh giá)
                            </p>
                        </div>
                                ...
                                if (variant.color) {
                                    return (
                                        <div className="col-3 px-3" key={index}>
                                            <div
                                                className={`${selectedColor == variant.color ? 'border-black' : ''} product-color p-2 h-100 border d-flex align-items-center justify-content-center`}
            ...
            <Modal show={showLoginModal} onHide={() => setShowLoginModal(false)}>
                ...
                <Modal.Body>Vui lòng đăng nhập để tiếp tục mua hàng</Modal.Body>
                <Modal.Footer>
