                ...
                <div className="profile-body">
                    <div className="profile-form col-8">
                        ...
                        <table className="table-content">
                                <tr>
                                    <td className="label-cell"><label>Tên</label></td>
                                ...
                                <tr>
                                    <td className="label-cell"><label>Email</label></td>
                                    <td className="input-cell">
                                        <div className="input-group d-inline-flex">
                                            <div className="readonly-input">tr**********@gmail.com</div>
                                            <a href="/user/account/email" className="btn-control" >Thay đổi</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="label-cell"><label>Số điện thoại</label></td>
                                    <td className="input-cell">
                                ...
                                <tr>
                                    <td className="label-cell"><label>Ngày sinh</label></td>
                                    <td className="input-cell">
                                        <div className="input-group">
                                ...
                                <tr>
                                    ...
                                    <td className="input-cell">
                                        <button type="button" className="btn btn-solid-primary">Lưu</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
