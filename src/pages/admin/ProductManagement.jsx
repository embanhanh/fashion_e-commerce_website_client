                ...
                <div key={index} className="product-grid product-row">
                    ...
                    <div className="d-flex align-items-center flex-column px-4">
                        <FontAwesomeIcon
                            ...
                            color="#4a90e2"
                            onClick={() => navigate(`/seller/products/edit/${product.slug}`)}
                        />
                        <FontAwesomeIcon
                            icon={faTrashCan}
                    ...
                    <div className="product-details">
                        ...
                        <div className="product-info">
                            ...
                            <div className="d-flex justify-content-center">
                                <FontAwesomeIcon
                                    icon={faPen}
                                    className="fs-3 p-2 mx-2 hover-icon"
                                    color="#4a90e2"
                                    onClick={() => navigate(`/seller/products/edit/${product.slug}`)}
                                />
                                <FontAwesomeIcon
                    ...
                    <div className="row p-3 g-4">
                        ...
                        <div className="col-6 d-flex align-items-center">
                            ...
                            <div className="input-form d-flex align-items-center w-100">
                                <input
                                    type="number"
                                    onChange={(e) => handleStockQuantityChange('min', e.target.value)}
                                    className="input-text w-100"
                                    placeholder="Từ"
                                />
                            </div>
                            ...
                            <div className="input-form d-flex align-items-center w-100">
                                <input
                                    type="number"
                                    onChange={(e) => handleStockQuantityChange('max', e.target.value)}
                                    className="input-text w-100"
                                    placeholder="Đến"
                                />
                            </div>
                        ...
                        <div className="col-6 d-flex align-items-center">
                            ...
                            <div className="input-form d-flex align-items-center w-100">
                                <input
                                    type="number"
                                    onChange={(e) => handleSoldQuantityChange('min', e.target.value)}
                                    className="input-text w-100"
                                    placeholder="Từ"
                                />
                            </div>
                            ...
                            <div className="input-form d-flex align-items-center w-100">
                                <input
                                    type="number"
                                    onChange={(e) => handleSoldQuantityChange('max', e.target.value)}
                                    className="input-text w-100"
                                    placeholder="Đến"
                                />
                            </div>
                        ...
                        <div className="d-flex">
                            <div className="select ">
                                <div
                                    ...
                                    data-one="Xóa các sản phẩm đang chọn"
                                    data-two="Thêm các sản phẩm mới"
                                >
                                    <svg
                                ...
                                <div className="options">
                                    ...
                                    <div title="option-1">
                                        ...
                                        <label
                                            className="option"
                                            htmlFor="option-1-v2"
                                            data-txt="Xóa các sản phẩm đang chọn"
                                        />
                                    </div>
                                    {/* <div title="option-2">
                                        <input
                            ...
                            <div className="select mx-3">
                                <div
                                    ...
                                    data-one="Giá bán tăng dần"
                                    data-two="Giá bán giảm dần"
                                    data-three="Tồn kho tăng dần"
                                    data-four="Tồn kho giảm dần"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        height="1em"
                        ...
                        <div className="border rounded-2 p-3">
                            <div className="product-header product-grid">
                                ...
                                <div className="d-flex align-items-center">
                                    <FontAwesomeIcon
                                        icon={faList}
                                        className={`fs-3 p-2 view-icon ${viewMode === 'list' ? 'active' : ''}`}
                                        onClick={() => setViewMode('list')}
                                    />
                                    <BsGridFill
                                        className={`p-2 ms-2 view-icon ${viewMode === 'grid' ? 'active' : ''}`}
                                        size={27.5}
